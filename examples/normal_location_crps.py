...
def main() -> None:
    ...
    # Data in R^1
    n = 250
    x = np.where(rng.random(n) < 0.4, rng.normal(-1.2, 0.5, n), rng.normal(1.6, 0.8, n))
    ...
    cfg = SamplerConfig(n_steps=6_000, burn_in=1_500, dt=8e-4, thin=10, seed=33)

    # CRPS-specific hyperparameters (example values)
